...
const Register = () => {
  ...
  return (
    <section>
      <section className="hero min-h-screen bg-login bg-center bg-cover bg-red-500 ">
      ...
      <div className="footer absolute bottom-0 left-0 items-end p-4 bg-[#F2BD57]  text-neutral-content">
        <div className="items-center grid-flow-col">
          <svg width="36" height="36" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" className="fill-current text-black">
