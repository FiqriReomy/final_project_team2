...
const Navbar_users = () => {
  ...
  return (
    <>
      {/* sidebar */}
      <div className={`${SidebarOpen ? "right-0" : "-right-full"}  w-full bg-white fixed top-0 h-full shadow-2xl md:w-[40vw] xl:max-w-[30vw] transision-all duration-300 z-50 px-4 lg:px-[35px]`}>
      ...
      {/* navbar */}
      <div className={`${bg ? "bg-white h-20 shadow-md" : "bg-none text-white shadow-none h-24 "}  items-center fixed top-0 w-full transision-all duration-500 z-30 px-10 navbar `}>
        <div className="mx-auto max-w-screen-xl px-5">
          <div className="menulogo justify-between">
        ...
        <div
          className={`menulist text-[14px] flex flex-col items-end  md:flex-row md:pb-0 pb-0 absolute md:static md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pr-9  ${menu ? "top-20 bg-white text-black" : "top-[-400px]"} ${
            bg ? "bg-white" : "bg-none text-white"
          }`}
        >
          <a className="py-2 px-5 font-semibold text-xl  hover:underline" href="#menu">
            Our Menu
