...
import { DASHBOARD_SIDEBAR_LINKS, DASHBOARD_SIDEBAR_BOTTOM_LINKS } from "../../controls/constants";
...
export default function Sidebar() {
  return (
    <div className="bg-neutral-900 w-60 p-3 flex flex-col h-full ">
      <div className="flex items-center gap-2 px-1 py-3">
        <FcBullish fontSize={24} />
        <span className="text-neutral-200 text-lg">FoodHolic</span>
      </div>
