          ...
          <div className="content py-5 flex flex-wrap justify-between items-center">
            {DataResult.map((data, index) => (
              <div className=" sm:w-full md:w-1/2 lg:w-1/4 p-2 " key={data.id}>
                <div className="display shadow-2xl relative cursor-pointer bg-white " onClick={() => setOpenModal(true)}>
                  <div className="image w-full overflow-hidden flex justify-center p-4">
                  ...
                  <div className="py-2 px-5 text-[15px] text-left flex justify-between items-center">
                    ...
                    <button className="py-2 px-4 bg-green-500 rounded">ORDER</button>
                  </div>
                </div>
              </div>
            ))}
