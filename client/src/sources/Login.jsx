  ...
  return (
    <section>
      <div className="hero min-h-screen bg-login bg-center bg-cover ">
              ...
              <div className="content p-5 ">
                <div className="loginbox w-[400px] shadow-xl rounded p-5 bg-white m-auto">
                  ...
                  <form className="px-4 mt-5" onSubmit={Auth}>
                    ...
                    <div className="py-3">
                      <button className="font-bold rounded w-full py-3 bg-green-500 active:scale-95 roundend-lg">LOGIN </button>
                    </div>
                    <div className="lupa">
                  ...
                  <div className="div flex justify-center gap-2 mb-5">
                    <button className="py-2 px-5 rounded border hover:bg-green-500 flex items-center gap-2">
                      <FaFacebookSquare className="text-2xl"/>
                      Facebook</button>
                    <button className="py-2 px-6 rounded border  hover:bg-green-500 flex items-center gap-2">
          ...
          <div className="footer absolute bottom-0 left-0 items-end p-4 bg-neutral text-neutral-content">
